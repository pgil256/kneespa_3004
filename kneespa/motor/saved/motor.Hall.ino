...
void emergencyStop() {
  if (micros() - lastStepBTime > trigDelay * 2) {
    STOP = true;
    Serial.println("STOP");
    lastStepBTime = micros();
  }
...
#ifdef DEBUG
  pressure = pressure; // abs(scale.get_units(10));
#else
